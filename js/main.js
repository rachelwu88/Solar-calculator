...
function shareResults() {
    var feedbackContent = document.getElementById('feedback').innerText;
    var encodedContent = encodeURIComponent(feedbackContent);
    var shareURL = `mailto:?subject=My Solar Panel Calculator Results&body=${encodedContent}`;
